...
use App\Http\Livewire\Instructor\CoursesMatricula;
...
Route::get('courses/{course}/matricula', CoursesMatricula::class)->middleware('can:Actualizar cursos')->name('courses.matricula');
