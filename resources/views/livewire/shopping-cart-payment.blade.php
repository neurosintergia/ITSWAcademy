<div>
    ...
    <div id="processingPayment" class="fixed left-0 top-16 w-full bg-black bg-opacity-75 hidden" style="height: 100vh; z-index: 300">
        ...
        <div class="container pt-8 px-6">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg max-w-lg mx-auto">
                ...
                <div class="px-6 py-4">
                    <p class="leading-5 text-gray-500 text-center font-semibold">El pago se está procesando, por favor no cierre ni actualice esta página. De haber un error en la compra, por favor escribenos a <a class="text-blue-500 hover:text-blue-700" href="intelisoftw@gmail.com">intelisoftw@gmail.com</a></p>
                </div>
    ...
    <div class="container mt-12">
            ...
            <div class="lg:col-span-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="flex justify-between">Precio original: <span>MXN$ {{ Cart::subtotal() }}</span></p>
                        <p class="flex justify-between">Descuento: <span>MXN$ 0</span></p>
                        <hr class="my-1">
                        <p class="flex justify-between mb-1 font-semibold">Total: <span>MXN$ {{ Cart::subtotal() }}</span>
                        </p>
        ...
        @push('js')
            {{-- SDK PayPal --}}
            <script src="https://www.paypal.com/sdk/js?client-id={{config('services.paypal.client_id')}}&currency=MXN&components=buttons,funding-eligibility" data-sdk-integration-source="button-factory"></script>
