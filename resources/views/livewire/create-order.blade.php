<div class="container py-8 grid lg:grid-cols-5 gap-6">
    <div class="col-span-3">
        <div class="bg-white rounded-lg shadow p-6">
                ...
                <div>
                    ...
                    <x-jet-input type="text"
                                ...
                                placeholder="Ingrese un numero de teléfono de contacto"
                                class="w-full" />
         ...
         <p class="mt-6 mb-3 text-lg text-gray-700 font-semibold">Envíos</p>
                ...
                <label class="bg-white rounded-lg shadow px-6 py-4 flex items-center mb-4">
                        ...
                        <span class="ml-2 text-gray-700">
                            Recojer en tienda (Ciudad de México )
                        </span>
                    ...
                    <div class="px-6 pb-6 grid grid-cols-2 gap-6 hidden" :class="{ 'hidden': envio_type !=2  }">
                            ...
                            <div>
                                ...
                                <select class="form-control w-full" wire:model="city_id">
                                    <option value="" disabled selected>Selecione un ciudad</option>
                            ...
                            <div>
                                ...
                                <select class="form-control w-full" wire:model="district_id">
                                    <option value="" disabled selected>Selecione una Localidad</option>
       ...
       {{-- <div>
            ...
            <hr>
                <p class="text-sm text-gray-700 mt-2">  sigue el proceso para finalizar con la solicitud <a href="" class="font-semibold text-blue-500">Politicas y privacidad</a> </p>
