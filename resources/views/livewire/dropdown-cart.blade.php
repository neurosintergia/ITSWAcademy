<div>
    <x-jet-dropdown width="96">
        ...
        <x-slot name="content">
            <ul class="text-gray-800">
                ...
                @forelse (Cart::content() as $item)
                   <li class="flex p-2 border-b border-gray-200">
                     <img class="w-20 h-16 object-cover object-center mr-4" src="{{ Storage::url($item->model->image->url) }}" alt="{{ $item->model->title }}">
            ...
            @if (Cart::count())
                <div class="py-2 px-3">
                    <p class="text-lg text-gray-700 mt-2 mb-3"><span class="font-bold">Total:</span> MXN$
                        {{ Cart::subtotal() }}</p>
