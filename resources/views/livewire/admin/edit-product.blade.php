<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <div class="mb-4" wire:ignore>
            <form action="{{ route('inventary.products.files', $product) }}" method="POST" class="dropzone"
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                ...
                <div>
                    ...
                    <select class="w-full form-control" wire:model="product.subcategorii_id">
                        <option value="" selected disabled>Seleccione una subcategoría</option>
                        @foreach ($subcategoriis as $subcategorii)
                            <option value="{{ $subcategorii->id }}">{{ $subcategorii->name }}</option>
                        @endforeach
                    </select>
                    <x-jet-input-error for="product.subcategorii_id" />
                </div>
            </div>
            {{-- Nombre --}}
            <div class="mb-4">
                <x-jet-label value="Nombre" />
                <x-jet-input type="text" wire:model="product.name" placeholder="Ingrese el nombre del producto"
                    class="w-full" />
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" disabled wire:model="slug" placeholder="Ingrese el slug del producto"
            ...
            <div class="mb-4">
                <div wire:ignore>
                    ...
                    <textarea class="w-full form-control" rows="4" wire:model="product.description" x-data x-init="ClassicEditor.create( $refs.Editor)
    ...
    @push('script')
        <script>
            Dropzone.options.myAwesomeDropzone = {
                ...
                dictDefaultMessage: "Arrastra una imagen al recuadro ",
                acceptedFiles: 'image/*',
