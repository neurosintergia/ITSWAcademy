        ...
        <div class="{{Cart::count() ? 'lg:col-span-3 order-2 lg:order-1' : ''}}">
            ...
            <div class="mb-8">
                ...
                @if (Cart::count())
                    ...
                    <button class="text-sm ml-2 font-semibold hover:text-red-600"
                        onclick="destroy_shopping_cart()">
            ...
            <div class="lg:col-span-2 order-1 lg:order-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-xs mb-2 text-justify">Comprueba que hayas agregado todos los cursos que quieres adquirir a tu carrito de compras, y luego procede con el pago</p>
