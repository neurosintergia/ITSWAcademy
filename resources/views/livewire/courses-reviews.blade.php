<section class="mt-4">
    ...
    @can('enrolled', $course)
       <article class="mb-4">
        ...
        @can('valued', $course)
            <textarea wire:model="comment" class="border-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full" placeholder="Escribe tu mensaje" rows="3" placeholder="Ingrese una reseña del curso"></textarea>   
 @error('comment')
        ...
        @enderror
            <div class="flex justify-end">
                ...
                <button class="btn btn-primary mr-3" wire:click="store">Guardar</button>
            </div>
