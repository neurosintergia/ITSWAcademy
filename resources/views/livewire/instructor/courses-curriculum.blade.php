...
<div class="m-2">
    ...
    <h1 class="text-2xl font-bold m-2">LECCIÓNES DEL CURSO</h1>
    ...
    <div class="m-8" x-data="{open: false}">
        <a x-show="!open" x-on:click="open = true"  class="flex items-center text-blue-900 font-bold text-lg cursor-pointer">
            <i class="far fa-plus-square text-2xl text-red-500 mr-2"></i>
            Agregar nueva sección
        </a>
        <div class="card" x-show="open">
            <div class="card-body bg-blue-100">
                <h1 class="text-xl text-blue-900 font-bold mb-4">Agregar nueva sección</h1>
                <div class="mb-4">
