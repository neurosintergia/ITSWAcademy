<section class="m-4">
    <h1 class="text-2xl font-bold m-4">ESTADO DEL CURSO</h1>
    <hr class="mt-2 mb-6">
    ...
    <article class="card">
        <div class="card-body bg-blue-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input rounded-lg w-full" placeholder=" Curso Completo o En desarrollo">
                @error('name')
                    <span class="text-xs text-red-500">{{$message}}</span>
                @enderror
