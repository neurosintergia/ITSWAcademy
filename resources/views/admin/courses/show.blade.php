    ...
    <section class="bg-gray-700 py-12 mb-12">
          ...
          <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
              ...
              @else 
              <img class="h-60 w-full object-cover" src="https://intelisoftw.com/wp-content/uploads/2019/03/itswacademy.png" alt="">
              @endif
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="fas fa-address-card"></i>Categoria: {{$course->category->name}}</p>
                ...
                <section class="card mb-12">
                    <div class="card-body">
                            ...
                            <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
                                ...
                                @empty
                                <li class="text-gray-700 text-base"> Este curso no tiene asignado niguna meta</li>
                                @endforelse
