...
class OrderController extends Controller
{
    ...
    $response = Http::get( "https://api.mercadopago.com/v1/payments/$payment_id" . "?access_token=APP_USR-204054134564270-061003-1605bad3e152373be15e6decfc91a9f4-773294060" );
